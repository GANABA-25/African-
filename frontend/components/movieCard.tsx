    ...
    <div className="group overflow-hidden rounded-xl border border-white/5 bg-surface shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/20 hover:shadow-[0_12px_35px_rgba(0,0,0,0.35)]">
      <div className="relative h-80 w-full cursor-pointer overflow-hidden bg-[#151515]">
        <Image
          ...
          src="https://res.cloudinary.com/dkjlpfa1q/image/upload/v1789723598/beast_u9ff99.webp"
          alt="Perfect Addiction"
        ...
        <div className="absolute right-3 top-3 flex items-center gap-1.5 rounded-lg border border-white/10 bg-black/60 px-2.5 py-1.5 text-xs font-semibold text-white backdrop-blur-md">
